...
public interface StudentJoinRepository extends JpaRepository<StudentPersonal, Integer> {
    ...
    @Query(value = "SELECT p.student_id, p.first_name, p.last_name, p.gender, p.email, p.dob, a.department, a.average_marks, att.attended_classes, att.total_classes, s.sport_name, s.level " +
